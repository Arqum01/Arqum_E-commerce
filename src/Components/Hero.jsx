...
const Hero = () => {
    ...
    <div class="container  py-16 lg:my-16 mx-auto">
            ...
            <div class="w-full lg:w-3/4 lg:ps-20 px-5">
                <div class="lg:my-20">
                    ...
                    <div class="flex flex-col mt-6 space-y-3 lg:space-y-0 lg:flex-row">
                        <Link class="w-full px-5 py-2 text-sm tracking-wider text-white uppercase transition-colors duration-300 transform bg-black rounded-lg lg:w-auto lg:mx-4 hover:bg-gray-500 focus:outline-none focus:bg-blue-500">
                            Shop Now!
                        </Link>
                    </div>
                </div> 
